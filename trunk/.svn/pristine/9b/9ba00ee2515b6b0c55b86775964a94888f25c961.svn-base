...
public class Nota {
    ...
    /* AS SEGUINTES CONSTANTES/VARIÁVEIS TEM O ÚNICO OBJETIVO DE MELHORAR A PERFORMANCE
     * DO SISTEMA, NÃO POSSUEM RELAÇÃO COM OS DADOS DAS NOTAS NO BANCO DE DADOS. SÃO
     * MARCADORES QUE DIZEM SE A NOTA DEVE SOFRER UPDATE OU INSERÇÃO NO BD.
     */
